...
<div class="row row align-items-center pt-2 pt-lg-5 mb-5">
    <div class="col-md-6">
...
<div class="row post-grid-mini mt-5">
  <div class="col-3">
  ...
  <div class="col-9">
    ...
    <p class="meta">
        ...
        <i class="fa fa-user-circle-o"></i> Profa. Raquel Aparecida Pegoraro <small>(Mentora)</small>
    </p>
  </div>
</div>
